...
int main( int argc , char **argv ) {
  ...
  yakl::init();
  {
    ...
    auto model = create_inference_model(
                    // Layer 1
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense/dense"     , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense/dense"     , "bias:0"   ) ) ,
                    Relu  ( neurons , negative_slope )                                         ,
                    Save_State<0>( neurons )                                                   ,
                    // Layer 2
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense_1/dense_1" , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense_1/dense_1" , "bias:0"   ) ) ,
                    Relu  ( neurons , negative_slope )                                         ,
                    Binop_Add <0>( neurons )                                                   ,
                    Save_State<0>( neurons )                                                   ,
                    // Layer 3
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense_2/dense_2" , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense_2/dense_2" , "bias:0"   ) ) ,
                    Relu  ( neurons , negative_slope )                                         ,
                    Binop_Add <0>( neurons )                                                   ,
                    Save_State<0>( neurons )                                                   ,
                    // Layer 4
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense_3/dense_3" , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense_3/dense_3" , "bias:0"   ) ) ,
                    Relu  ( neurons , negative_slope )                                         ,
                    Binop_Add <0>( neurons )                                                   ,
                    Save_State<0>( neurons )                                                   ,
                    // Layer 5
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense_4/dense_4" , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense_4/dense_4" , "bias:0"   ) ) ,
                    Relu  ( neurons , negative_slope )                                         ,
                    Binop_Add <0>( neurons )                                                   ,
                    Save_State<0>( neurons )                                                   ,
                    // Layer 6
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense_5/dense_5" , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense_5/dense_5" , "bias:0"   ) ) ,
                    Relu  ( neurons , negative_slope )                                         ,
                    Binop_Add <0>( neurons )                                                   ,
                    Save_State<0>( neurons )                                                   ,
                    // Layer 7
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense_6/dense_6" , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense_6/dense_6" , "bias:0"   ) ) ,
                    Relu  ( neurons , negative_slope )                                         ,
                    Binop_Add <0>( neurons )                                                   ,
                    Save_State<0>( neurons )                                                   ,
                    // Layer 8
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense_7/dense_7" , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense_7/dense_7" , "bias:0"   ) ) ,
                    Relu  ( neurons , negative_slope )                                         ,
                    Binop_Add <0>( neurons )                                                   ,
                    Save_State<0>( neurons )                                                   ,
                    // Layer 9
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense_8/dense_8" , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense_8/dense_8" , "bias:0"   ) ) ,
                    Relu  ( neurons , negative_slope )                                         ,
                    Binop_Add <0>( neurons )                                                   ,
                    // Layer 10
                    Matvec( load_h5_weights<2>( fname_h5 , "/dense_9/dense_9" , "kernel:0" ) ) ,
                    Bias  ( load_h5_weights<1>( fname_h5 , "/dense_9/dense_9" , "bias:0"   ) ) );
    ...
    yakl::Array<float,2,yakl::memHost,yakl::styleC> inputs("inputs",datavec.data(),137,1);

    auto out_host = model.batch_parallel( inputs.createDeviceCopy() ).createHostCopy();
