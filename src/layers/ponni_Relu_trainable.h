...
namespace ponni {
  ...
  struct Relu_Trainable {
    ...
    Relu_Trainable() {};
    Relu_Trainable( int num_inputs , int num_ensembles=1 , real negative_slope=0 , real threshold=0 , real max_value=huge ,
          bool trainable=true ) {
      init(num_inputs,num_ensembles,negative_slope,threshold,max_value,trainable);
    }
    Relu_Trainable( int num_inputs , real1d negative_slope , real threshold=0 , real max_value=huge , bool trainable=true ) {
      init(num_inputs,negative_slope,threshold,max_value,trainable);
    }
    Relu_Trainable( int num_inputs , real2d negative_slope , real threshold=0 , real max_value=huge , bool trainable=true ) {
      init(num_inputs,negative_slope,threshold,max_value,trainable);
    }
    ...
    void init( int num_inputs , int num_ensembles=1 , real negative_slope=0 , real threshold=0 ,
      ...
      params.negative_slope    = real2d("Relu_Trainable_negative_slope",num_inputs,num_ensembles);
    ...
    doubleHost1d to_array() const {
      doubleHost1d data("Relu_Trainable_params",get_array_representation_size());
    ...
    void from_array(doubleHost1d const &data) {
      ...
      realHost1d negative_slope("Relu_Trainable_negative_slope",num_inputs*nens);
